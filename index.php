      ...
      <form action="add_regis.php">
        <div class="container">
          ...
          <input type="text" name="fm_tel" id="fm_tel" >
					...
					<label for="fm_exp"><b>Your Expertise</b></label>
          <input type="text" name="fm_exp" id="fm_exp" >
